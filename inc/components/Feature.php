<?php
  $title = '[title]塗装のプロフェッショナルの強み[/title]';
  ...
  $features = [
    [
      ...
      'image' => "$theme_url/assets/images/image-feature1.jpg",
    ],
    [
      'title' => 'アフター保証',
    ...
    [
      ...
      'image' => "$theme_url/assets/images/image-feature4.jpg",
    ],
  ]
?>
